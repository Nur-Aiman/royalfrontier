                                            ...
                                            <form action="../Login" method="post">
                                                ...
                                                <div class="form-group mt-2">
                                                    <input type="password" name="password" class="form-style"
                                                        placeholder="Enter Password" id="logpass" autocomplete="off">
                                                    <i class="input-icon uil uil-lock-alt"></i>
                                                </div>
                                                <input style="background-color:yellow;  color:black" type="submit"
                                                    class="btn btn-primary" value="Login">
                                                <a href="ForgotPassword.jsp"
                                                    class="mt-3 d-block text-center">Forgot Password?</a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <form action="../Register" method="post">
                                                ...
                                                <input style="color:black; background-color:yellow;" type="submit"
                                                    value="Register" class="btn mt-4">
                                            </form>
                                        </div>
                                    </div>
                                </div>
