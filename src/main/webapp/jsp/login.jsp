...
<body>
	...
	<a href="../index.jsp" class="logo" target="_blank"> <img
		style="width: 20%; height: 20%;" src="https://i.imgur.com/jLxNPym.png"
		alt="">
	</a>
			...
			<div class="row full-height justify-content-center">
				<div class="col-12 text-center align-self-center py-5">
					<div class="section pb-5 pt-5 pt-sm-2 text-center">
						<h6 class="mb-0 pb-3">
							<span style="color: white;">Log In </span><span
								style="color: white;">Sign Up</span>
						</h6>
									...
									<div class="center-wrap">
										<div class="section text-center">
											...
											<form action="../Register" method="post">
												...
												<input style="color: black; background-color: yellow;"
													type="submit" value="Register" class="btn mt-4">
											</form>
										</div>
									</div>
								</div>
